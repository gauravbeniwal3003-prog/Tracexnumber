...
"""
        ...
        for idx, data in enumerate(results, 1):
            ...
            alt_mobile = data.get('alt_mobile', data.get('alternate_mobile', 'N/A'))
            ...
            aadhar = data.get('aadhar_number', data.get('aadhar', 'N/A'))
            if aadhar == 'n/a':
                aadhar = 'N/A'
                
            operator = data.get('operator', 'N/A')
            circle = data.get('state_circle', data.get('circle', 'N/A'))
